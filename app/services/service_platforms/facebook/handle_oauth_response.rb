  ...
  module Facebook
    class HandleOauthResponse
      ...
      def call
        ...
        parent_profile_id = ServicePlatforms::Facebook::GetProfile.new(access_token, token_values[:store_id]).call
        ServicePlatforms::Facebook::GetPages.new(access_token, token_values[:store_id], parent_profile_id).call
        ServicePlatforms::Facebook::GetGroups.new(access_token, token_values[:store_id], parent_profile_id).call
      end
    end
  end
end